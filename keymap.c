...
enum combo_events {
    COMBO_HANGUL,     // J + L -> Korean/English input toggle
 ...
 *   J+L combo -> input source switch.  Q+W combo -> region screenshot.
 */
...
[_NUM] = LAYOUT_ortho_4x12(
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_P1  , KC_P2, KC_P3  , KC_EQL , KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_P0, KC_PDOT, KC_TRNS, KC_TRNS
),

/* Func (Func+M = Windows/Mac mode; Func+Enter = Delete) */
    ...
    switch (combo_index) {
        case COMBO_HANGUL:
            if (user_config.mac_mode) {
                ...
                // Windows: the real Hangul key -- works out of the box with the
                // Korean IME, no OS-side hotkey configuration needed.
                tap_code(KC_LNG1);
            }
            break;
